...
public class XmlWriter {
    ...
    public static void xmlWrite(String title, String referenceNo, String ocid, String publishedby, String publicationDate,String mainContactEmail, String url) {
        ...
        try {
            ...
            Element rootElement =
                doc.createElementNS("https://www.publiccontractsscotland.gov.uk/", "Contarcts");
            ...
            StreamResult file = new StreamResult(new File("customize notices.xml"));
    ...
    private static Node getNotice(Document doc, String title, String referenceNo, String ocid, String publishedby, String publicationDate,String mainContactEmail,String url) {
